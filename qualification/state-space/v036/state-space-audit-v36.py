#!/usr/bin/env python3
"""Incremental global regression/state-space audit through ADR-068, revision H4-ratified.

Retains the valid v35 finite regression baseline and adds an explicit hostile-audit
H4 family proving that durably adopted PromotionUnit PROMOTED is historical terminal
completion rather than a perpetual current-target-membership predicate. Current
normative static checks and all concrete Git primitive smokes are rerun.
"""
...
assert 'STATE-SPACE-AUDIT-v36.md' in main
assert (ROOT/'STATE-SPACE-AUDIT-v36.md').exists()
...
print(f'v36 changed/revalidated finite combinations: {RETAINED_V32+changed_v34+adr068_changed+h4_changed}')
