#!/usr/bin/env python3
"""Global regression/state-space audit through ADR-052 DIRECT target CAS+FF semantics.
...
v20 and adds explicit coverage for ADR-052 exact-old CAS+FF DIRECT target
advancement, no target-worktree staging, authoritative-history recovery adoption,
and recovery-anchor cleanup eligibility.
"""
...
def static_consistency_checks():
    ...
    assert nums == list(range(1, 53)), nums
...
def main():
    ...
    print("Ruu state-space audit v21: PASS")
