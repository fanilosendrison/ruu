...
>
> This document explains the current architecture through ADR-080 and is intended to let a new reader build the right mental model before reading the full specification and decision history. It does **not** introduce requirements, states, identities, or authority rules of its own. If this overview conflicts with [`RUU-SPEC.md`](RUU-SPEC.md), [`EXTERNAL-CONTROL-PLANE-CONTRACT.md`](EXTERNAL-CONTROL-PLANE-CONTRACT.md), or a governing ADR, those normative sources control.
...
Normative anchors: [ADR-015](ADR-015-provision-repository-local-convergence-unit-ref-before-first-contribution-unit.md), [ADR-023](ADR-023-separate-contribution-unit-provisioning-from-ruu.md), [ADR-061](ADR-061-bind-each-convergence-unit-to-an-immutable-pre-authoring-promotion-target.md), [ADR-078](ADR-078-make-zero-preflight-coding-harness-integration-part-of-the-governing-product-intent.md).
...
Normative anchors: [EXTERNAL-CONTROL-PLANE-CONTRACT.md](EXTERNAL-CONTROL-PLANE-CONTRACT.md), [ADR-039](ADR-039-formalize-external-control-plane-contract.md), [ADR-057](ADR-057-externalize-development-verification-and-model-ruu-as-state-dependent-git-progression.md), [ADR-070](ADR-070-make-hands-off-concurrent-invoke-anywhere-convergence-the-governing-product-intent.md).
...
Normative anchor: [ADR-061](ADR-061-bind-each-convergence-unit-to-an-immutable-pre-authoring-promotion-target.md).
...
Normative anchors: specification §2.2, [ADR-006](ADR-006-use-target-convergence-unit-contribution-unit-hierarchy.md), [ADR-015](ADR-015-provision-repository-local-convergence-unit-ref-before-first-contribution-unit.md), [ADR-037](ADR-037-eagerly-integrate-contribution-checkpoints-and-seal-convergence-before-readiness.md).
...
Normative anchors: [ADR-001](ADR-001-isolate-concurrent-work-production-with-git-worktrees.md), [ADR-002](ADR-002-use-repository-local-contribution-units-as-the-isolation-unit.md), [ADR-035](ADR-035-use-bounded-contribution-units-with-external-lifecycle-authority.md), [ADR-038](ADR-038-decouple-contribution-unit-identity-from-editing-artifacts.md), [ADR-073](ADR-073-require-git-worktrees-as-the-v1-authoring-isolation-substrate.md).
...
Normative anchors: [ADR-007](ADR-007-converge-every-edge-bidirectionally-to-a-fixed-point.md), [ADR-012](ADR-012-isolate-integration-workspaces-and-model-conflicts-as-blocked-states.md), [ADR-016](ADR-016-use-an-append-only-no-rebase-v1-reconciliation-strategy.md), [ADR-017](ADR-017-derive-fast-forward-and-divergence-from-exact-git-ancestry.md), [ADR-037](ADR-037-eagerly-integrate-contribution-checkpoints-and-seal-convergence-before-readiness.md).
...
Normative anchors: [ADR-010](ADR-010-bind-readiness-and-validation-to-exact-git-state.md), [ADR-011](ADR-011-use-an-atomic-convergence-unit-readiness-promotion-barrier.md), [ADR-037](ADR-037-eagerly-integrate-contribution-checkpoints-and-seal-convergence-before-readiness.md).
...
Normative anchors: [ADR-064](ADR-064-bind-pre-commit-readiness-by-frozen-mutation-handoff.md), [ADR-069](ADR-069-bind-promotion-groups-to-work-bearing-invocations-and-group-local-exact-state.md), [ADR-070](ADR-070-make-hands-off-concurrent-invoke-anywhere-convergence-the-governing-product-intent.md).
...
Normative anchors: [ADR-036](ADR-036-make-every-invocation-global-over-all-nonterminal-managed-obligations.md), [ADR-041](ADR-041-coalesce-convergence-demands-under-a-single-host-fenced-executor.md), [ADR-069](ADR-069-bind-promotion-groups-to-work-bearing-invocations-and-group-local-exact-state.md).
...
Normative anchors: [ADR-004](ADR-004-make-convergence-global-across-registered-repositories.md), [ADR-005](ADR-005-coordinate-simultaneous-convergers-with-fine-grained-claims-and-cas.md), [ADR-036](ADR-036-make-every-invocation-global-over-all-nonterminal-managed-obligations.md), [ADR-041](ADR-041-coalesce-convergence-demands-under-a-single-host-fenced-executor.md), [ADR-042](ADR-042-use-a-reconciler-driven-coordination-store-with-os-owned-runs-and-append-only-effect-journal.md), [ADR-072](ADR-072-make-host-run-lock-handles-non-inheritable-across-subprocess-boundaries.md).
...
Normative anchors: [ADR-046](ADR-046-predeclare-closed-promotion-groups-and-resolve-them-to-exact-promotion-units.md) as amended, [ADR-069](ADR-069-bind-promotion-groups-to-work-bearing-invocations-and-group-local-exact-state.md).
...
Normative anchors: [ADR-045](ADR-045-make-promotion-units-immutable-content-addressed-exact-state-sets.md), [ADR-047](ADR-047-project-promotion-groups-deterministically-into-repository-local-promotion-units.md), [ADR-048](ADR-048-materialize-repository-local-multi-source-promotion-units-by-canonical-pairwise-merging.md), [ADR-061](ADR-061-bind-each-convergence-unit-to-an-immutable-pre-authoring-promotion-target.md).
...
Normative anchor: [ADR-052](ADR-052-advance-direct-targets-by-atomic-exact-old-cas-fast-forward.md).
...
Normative anchors: [ADR-049](ADR-049-separate-stable-submission-identity-and-refs-from-internal-exact-state.md), [ADR-062](ADR-062-make-promotion-route-independent-and-provider-submissions-projections.md), [ADR-065](ADR-065-prove-final-promotion-realization-by-native-git-or-exact-provider-result-binding.md), [ADR-066](ADR-066-bind-promotion-success-to-route-conformant-candidate-submission-result-target-chains.md).
...
Normative anchor: [ADR-050](ADR-050-derive-stacked-publication-from-unsatisfied-promotion-dependencies-and-restack-by-exact-state-transplant.md).
...
Normative anchors: [ADR-074](ADR-074-minimize-native-git-event-observation-to-managed-authoring-binding-disposition.md), [ADR-075](ADR-075-require-pre-linearization-native-ref-witnesses-and-state-rediscovery-by-observation-class.md), [ADR-076](ADR-076-separate-native-witness-provenance-from-managed-effect-identity-and-make-semantic-adoption-idempotent.md), [ADR-077](ADR-077-require-attested-repository-common-observer-coverage-without-owning-foreign-git-mutation-infrastructure.md), [ADR-079](ADR-079-minimize-native-git-rejection-with-conservative-protection-filtering-and-exact-binding-admission.md), [ADR-080](ADR-080-separate-local-git-causality-remote-git-state-and-provider-workflow-evidence.md).
...
Normative anchors: [ADR-005](ADR-005-coordinate-simultaneous-convergers-with-fine-grained-claims-and-cas.md), [ADR-042](ADR-042-use-a-reconciler-driven-coordination-store-with-os-owned-runs-and-append-only-effect-journal.md), [ADR-065](ADR-065-prove-final-promotion-realization-by-native-git-or-exact-provider-result-binding.md), [ADR-071](ADR-071-make-managed-branch-deletion-durable-abandonment-and-fence-realization-by-current-disposition.md), [ADR-076](ADR-076-separate-native-witness-provenance-from-managed-effect-identity-and-make-semantic-adoption-idempotent.md), [ADR-080](ADR-080-separate-local-git-causality-remote-git-state-and-provider-workflow-evidence.md).
...
1. **[`RUU-SPEC.md`](RUU-SPEC.md)** — normative consolidated model.
2. **[`EXTERNAL-CONTROL-PLANE-CONTRACT.md`](EXTERNAL-CONTROL-PLANE-CONTRACT.md)** — authority boundary with the Development System.
3. **[ADR-070](ADR-070-make-hands-off-concurrent-invoke-anywhere-convergence-the-governing-product-intent.md)** and **[ADR-078](ADR-078-make-zero-preflight-coding-harness-integration-part-of-the-governing-product-intent.md)** — governing product experience.
4. **[ADR-015](ADR-015-provision-repository-local-convergence-unit-ref-before-first-contribution-unit.md), [ADR-035](ADR-035-use-bounded-contribution-units-with-external-lifecycle-authority.md), [ADR-037](ADR-037-eagerly-integrate-contribution-checkpoints-and-seal-convergence-before-readiness.md), [ADR-061](ADR-061-bind-each-convergence-unit-to-an-immutable-pre-authoring-promotion-target.md), [ADR-073](ADR-073-require-git-worktrees-as-the-v1-authoring-isolation-substrate.md)** — pre-edit topology and authoring lifecycle.
5. **[ADR-036](ADR-036-make-every-invocation-global-over-all-nonterminal-managed-obligations.md), [ADR-041](ADR-041-coalesce-convergence-demands-under-a-single-host-fenced-executor.md), [ADR-042](ADR-042-use-a-reconciler-driven-coordination-store-with-os-owned-runs-and-append-only-effect-journal.md), [ADR-069](ADR-069-bind-promotion-groups-to-work-bearing-invocations-and-group-local-exact-state.md)** — invocation and reconciler model.
6. **[ADR-045](ADR-045-make-promotion-units-immutable-content-addressed-exact-state-sets.md) through [ADR-050](ADR-050-derive-stacked-publication-from-unsatisfied-promotion-dependencies-and-restack-by-exact-state-transplant.md), plus [ADR-062](ADR-062-make-promotion-route-independent-and-provider-submissions-projections.md)** — promotion model and provider projection.
7. **[ADR-074](ADR-074-minimize-native-git-event-observation-to-managed-authoring-binding-disposition.md) through [ADR-080](ADR-080-separate-local-git-causality-remote-git-state-and-provider-workflow-evidence.md)** — local/remote/provider observation and native-Git coexistence.
8. **[`OPEN-DESIGN-BACKLOG.md`](OPEN-DESIGN-BACKLOG.md)** only after the current model is understood; it contains design history and remaining open nodes rather than the primary architecture description.
